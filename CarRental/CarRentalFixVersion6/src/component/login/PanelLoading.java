...
public class PanelLoading extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        closeButton = new swing.login.CloseButton();
        ...
        closeButton.setBackground(new java.awt.Color(32, 34, 47));
        closeButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/login/close1.png"))); // NOI18N
    ...
    private void closeButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_closeButtonMouseEntered
        closeButton.setBackground(new Color(52, 54, 67));
    }//GEN-LAST:event_closeButtonMouseEntered

    private void closeButtonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_closeButtonMouseExited
        closeButton.setBackground(new Color(32, 34, 47));
    ...
    private swing.login.CloseButton closeButton;

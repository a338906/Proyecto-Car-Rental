...
public class Message extends javax.swing.JDialog {
    ...
    public Message(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        lbIcon.setIcon(IconFontSwing.buildIcon(GoogleMaterialDesignIcons.REPORT_PROBLEM, 60, new Color(255, 0, 0), new Color(0, 0, 0)));
        setOpacity(0f);
    ...
    private void initComponents() {
        ...
        button2.setFont(new java.awt.Font("SansSerif", 0, 11)); // NOI18N
        ...
        button1.setFont(new java.awt.Font("SansSerif", 0, 11)); // NOI18N

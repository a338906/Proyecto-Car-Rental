...
public final class Dates extends javax.swing.JPanel {
    ...
    public void showDate(int month, int year, SelectedDate select) {
        ...
        for (int i = 1; i <= max_of_month; i++) {
            ...
            if (i < DAY && month == MONTH && year == YEAR) {
                ...
                cmd.setForeground(new Color(200, 200, 200));
            } else if (i == DAY && month == MONTH && year == YEAR) {
                cmd.setBackground(new Color(229, 229, 229));
            } else {
                cmd.setBackground(Color.WHITE);
            }
    ...
    public void clearSelected() {
        for (int i = 7; i < getComponentCount(); i++) {
            ...
            } else if (i < DAY + 7 && MONTH == m && y == YEAR) {
                cmd.setBackground(Color.WHITE);
                cmd.setForeground(new Color(200, 200, 200));
            } else {
                cmd.setBackground(Color.WHITE);
    ...
    private void addEvent(int mon, int year) {
        for (int i = 7; i < getComponentCount(); i++) {
            if (MONTH == mon && YEAR == year) {
                if (i >= DAY + 6) {
                    ((Button) getComponent(i)).setEvent(event);
                } else {
                    ((Button) getComponent(i)).setEvent(null);
                }
            } else {
                ((Button) getComponent(i)).setEvent(event);
            }
    ...
    private void initComponents() {
        ...
        cmdMo.setForeground(new java.awt.Color(0, 102, 255));
        cmdMo.setText("L");
        cmdMo.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        add(cmdMo);

        cmdTu.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 5, 1));
        cmdTu.setForeground(new java.awt.Color(0, 102, 255));
        cmdTu.setText("M");
        cmdTu.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        add(cmdTu);

        cmdWe.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 5, 1));
        cmdWe.setForeground(new java.awt.Color(0, 102, 255));
        cmdWe.setText("M");
        cmdWe.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        add(cmdWe);

        cmdTh.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 5, 1));
        cmdTh.setForeground(new java.awt.Color(0, 102, 255));
        cmdTh.setText("J");
        cmdTh.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        add(cmdTh);

        cmdFr.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 5, 1));
        cmdFr.setForeground(new java.awt.Color(0, 102, 255));
        cmdFr.setText("V");
        cmdFr.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        add(cmdFr);

        cmdSa.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 5, 1));
        cmdSa.setForeground(new java.awt.Color(0, 102, 255));
        cmdSa.setText("S");
        cmdSa.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        add(cmdSa);

        cmdSu.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 5, 1));
        cmdSu.setForeground(new java.awt.Color(0, 102, 255));
        cmdSu.setText("D");
        cmdSu.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        add(cmdSu);

        cmd1.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd1.setName("day"); // NOI18N
        add(cmd1);

        cmd2.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd2.setName("day"); // NOI18N
        add(cmd2);

        cmd3.setText("1");
        cmd3.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd3.setName("day"); // NOI18N
        add(cmd3);

        cmd4.setText("2");
        cmd4.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd4.setName("day"); // NOI18N
        add(cmd4);

        cmd5.setText("3");
        cmd5.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd5.setName("day"); // NOI18N
        add(cmd5);

        cmd6.setText("4");
        cmd6.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd6.setName("day"); // NOI18N
        add(cmd6);

        cmd7.setText("5");
        cmd7.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd7.setName("day"); // NOI18N
        add(cmd7);

        cmd8.setText("6");
        cmd8.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd8.setName("day"); // NOI18N
        add(cmd8);

        cmd9.setText("7");
        cmd9.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd9.setName("day"); // NOI18N
        add(cmd9);

        cmd10.setText("8");
        cmd10.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd10.setName("day"); // NOI18N
        add(cmd10);

        cmd11.setText("9");
        cmd11.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd11.setName("day"); // NOI18N
        add(cmd11);

        cmd12.setText("10");
        cmd12.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd12.setName("day"); // NOI18N
        add(cmd12);

        cmd13.setText("11");
        cmd13.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd13.setName("day"); // NOI18N
        add(cmd13);

        cmd14.setText("12");
        cmd14.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd14.setName("day"); // NOI18N
        add(cmd14);

        cmd15.setText("13");
        cmd15.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd15.setName("day"); // NOI18N
        add(cmd15);

        cmd16.setText("14");
        cmd16.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd16.setName("day"); // NOI18N
        add(cmd16);

        cmd17.setText("15");
        cmd17.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd17.setName("day"); // NOI18N
        add(cmd17);

        cmd18.setText("16");
        cmd18.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd18.setName("day"); // NOI18N
        add(cmd18);

        cmd19.setText("17");
        cmd19.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd19.setName("day"); // NOI18N
        add(cmd19);

        cmd20.setText("18");
        cmd20.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd20.setName("day"); // NOI18N
        add(cmd20);

        cmd21.setText("19");
        cmd21.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd21.setName("day"); // NOI18N
        add(cmd21);

        cmd22.setText("20");
        cmd22.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd22.setName("day"); // NOI18N
        add(cmd22);

        cmd23.setText("21");
        cmd23.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd23.setName("day"); // NOI18N
        add(cmd23);

        cmd24.setText("22");
        cmd24.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd24.setName("day"); // NOI18N
        add(cmd24);

        cmd25.setText("23");
        cmd25.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd25.setName("day"); // NOI18N
        add(cmd25);

        cmd26.setText("24");
        cmd26.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd26.setName("day"); // NOI18N
        add(cmd26);

        cmd27.setText("25");
        cmd27.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd27.setName("day"); // NOI18N
        add(cmd27);

        cmd28.setText("26");
        cmd28.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd28.setName("day"); // NOI18N
        add(cmd28);

        cmd29.setText("27");
        cmd29.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd29.setName("day"); // NOI18N
        add(cmd29);

        cmd30.setText("28");
        cmd30.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd30.setName("day"); // NOI18N
        add(cmd30);

        cmd31.setText("29");
        cmd31.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd31.setName("day"); // NOI18N
        add(cmd31);

        cmd32.setText("30");
        cmd32.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd32.setName("day"); // NOI18N
        add(cmd32);

        cmd33.setText("31");
        cmd33.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd33.setName("day"); // NOI18N
        add(cmd33);

        cmd34.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd34.setName("day"); // NOI18N
        add(cmd34);

        cmd35.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd35.setName("day"); // NOI18N
        add(cmd35);

        cmd36.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd36.setName("day"); // NOI18N
        add(cmd36);

        cmd37.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd37.setName("day"); // NOI18N
        add(cmd37);

        cmd38.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd38.setName("day"); // NOI18N
        add(cmd38);

        cmd39.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd39.setName("day"); // NOI18N
        add(cmd39);

        cmd40.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd40.setName("day"); // NOI18N
        add(cmd40);

        cmd41.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        cmd41.setName("day"); // NOI18N
        add(cmd41);

        cmd42.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
    ...
    public void setEvent(Event event, int mon, int year) {
        this.event = event;
        addEvent(mon, year);
    }

...
public class TextFieldAnimation extends JTextField {
    ...
    private String hintText = "Buscar correo ...";
    ...
    public TextFieldAnimation() {
        ...
        iconSearch = new ImageIcon(getClass().getResource("/icon/login/search.png"));
        iconClose = new ImageIcon(getClass().getResource("/icon/login/close1.png"));
        iconLoading = new ImageIcon(getClass().getResource("/icon/login/search.gif"));
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(35, 0, new Color(255, 255, 255), width, 0, animationColor);
        g2.setPaint(gra);
